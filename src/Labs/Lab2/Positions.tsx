export default function Positions(){
    ...
    <div>
        ...
        {/* Absolute moves elements from ther normal rendering. it is then no longer 
        used to calculate other elements nor the parent height, nor pushing elements
        Below no children contribute to the height hence no grey */} 
